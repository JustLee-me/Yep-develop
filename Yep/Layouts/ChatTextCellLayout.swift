...
class ChatTextCellLayout {
    ...
    fileprivate func textContentTextViewWidthOfMessage(_ message: Message, textContentTextViewMaxWidth: CGFloat) -> CGFloat {
        ...
        let rect = message.textContent.boundingRect(with: CGSize(width: textContentTextViewMaxWidth, height: CGFloat(Float.greatestFiniteMagnitude)), options: [.usesLineFragmentOrigin, .usesFontLeading], attributes: YepConfig.ChatCell.textAttributes, context: nil)
