...
//    }
    ...
    func application(_ application: UIApplication, continue userActivity: NSUserActivity, restorationHandler: @escaping ([Any]?) -> Void) -> Bool {
        ...
        println("userActivity.userInfo: \(String(describing: userActivity.userInfo))")
    ...
    fileprivate func cacheInAdvance() {
        ...
        DispatchQueue.global(qos: .background).async {
            ...
            let conversations = realm.objects(Conversation.self).filter(predicate).sorted(byKeyPath: "updatedUnixTime", ascending: false)
