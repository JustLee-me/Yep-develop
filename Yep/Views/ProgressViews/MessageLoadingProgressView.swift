...
final class MessageLoadingProgressView: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        let baseCircle = UIBezierPath(arcCenter: center, radius: radius, startAngle: 0, endAngle: CGFloat(Double.pi * 2), clockwise: true)
        ...
        let progressArc = UIBezierPath(arcCenter: center, radius: radius, startAngle: CGFloat(-Double.pi / 2), endAngle: CGFloat(Double.pi * 2 * progress - Double.pi / 2), clockwise: true)
