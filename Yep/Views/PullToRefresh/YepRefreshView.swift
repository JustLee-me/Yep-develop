...
final class YepShape: CAShapeLayer {
    ...
    func setupPathWithWidth(_ width: CGFloat, height: CGFloat) {
        ...
        let bottomGap = height / CGFloat(tan(Double.pi / 3))
...
final class YepRefreshView: UIView {
    ...
    override init(frame: CGRect) {
        ...
        leafShape1.transform = CATransform3DMakeRotation(CGFloat(-Double.pi / 6), 0.0, 0.0, 1.0)
        leafShape2.transform = CATransform3DMakeRotation(CGFloat(Double.pi / 2), 0.0, 0.0, 1.0)
        leafShape3.transform = CATransform3DMakeRotation(CGFloat(-Double.pi + Double.pi / 6), 0.0, 0.0, 1.0)
