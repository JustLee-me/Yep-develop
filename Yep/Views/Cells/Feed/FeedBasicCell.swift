...
class FeedBasicCell: UITableViewCell {
    ...
    class func heightOfFeed(_ feed: DiscoveredFeed) -> CGFloat {
        ...
        let rect = feed.body.boundingRect(with: CGSize(width: FeedBasicCell.messageTextViewMaxWidth, height: CGFloat(Float.greatestFiniteMagnitude)), options: [.usesLineFragmentOrigin, .usesFontLeading], attributes: YepConfig.FeedBasicCell.textAttributes, context: nil)
