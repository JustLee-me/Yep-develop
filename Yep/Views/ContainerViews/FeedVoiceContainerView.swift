...
final class FeedVoiceContainerView: UIView {
    ...
    class func fullWidthWithSampleValuesCount(_ count: Int, timeLengthString: String) -> CGFloat {
        let rect = timeLengthString.boundingRect(with: CGSize(width: 320, height: CGFloat(Float.greatestFiniteMagnitude)), options: [.usesLineFragmentOrigin, .usesFontLeading], attributes: YepConfig.FeedBasicCell.voiceTimeLengthTextAttributes, context: nil)
