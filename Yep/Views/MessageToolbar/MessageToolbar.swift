...
final class MessageToolbar: UIToolbar {
    ...
    func updateHeightOfMessageTextView() {
        ...
        let size = messageTextView.sizeThatFits(CGSize(width: messageTextView.bounds.width, height: CGFloat(Float.greatestFiniteMagnitude)))
    ...
    func updateDraft(_ notification: Notification) {
