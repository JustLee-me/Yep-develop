...
final class FeedView: UIView {
    ...
    var normalHeight: CGFloat {
        ...
        let rect = feed.body.boundingRect(with: CGSize(width: FeedView.messageTextViewMaxWidth, height: CGFloat(Float.greatestFiniteMagnitude)), options: [.usesLineFragmentOrigin, .usesFontLeading], attributes: YepConfig.FeedView.textAttributes, context: nil)
    ...
    fileprivate func calHeightOfMessageTextView() {
        ...
        let rect = messageTextView.text.boundingRect(with: CGSize(width: FeedView.messageTextViewMaxWidth, height: CGFloat(Float.greatestFiniteMagnitude)), options: [.usesLineFragmentOrigin, .usesFontLeading], attributes: YepConfig.FeedView.textAttributes, context: nil)
