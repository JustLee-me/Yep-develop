...
final class ProfileViewController: SegueViewController, CanScrollsToTop {
    ...
    fileprivate var footerCellHeight: CGFloat {
        ...
        let rect = self.introductionText.boundingRect(with: CGSize(width: labelWidth, height: CGFloat(Float.greatestFiniteMagnitude)), options: [.usesLineFragmentOrigin, .usesFontLeading], attributes:attributes, context:nil)
...
extension ProfileViewController: UICollectionViewDataSource, UICollectionViewDelegate, UIGestureRecognizerDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView!, layout collectionViewLayout: UICollectionViewLayout!, sizeForItemAtIndexPath indexPath: IndexPath!) -> CGSize {
        ...
        case .master:
            ...
            let rect = skillLocalName.boundingRect(with: CGSize(width: CGFloat(Float.greatestFiniteMagnitude), height: SkillCell.height), options: [.usesLineFragmentOrigin, .usesFontLeading], attributes: skillTextAttributes, context: nil)
