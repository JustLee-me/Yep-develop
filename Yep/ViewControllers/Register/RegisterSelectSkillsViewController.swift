    ...
    func collectionView(_ collectionView: UICollectionView!, layout collectionViewLayout: UICollectionViewLayout!, sizeForItemAtIndexPath indexPath: IndexPath!) -> CGSize {
        ...
        if collectionView == skillCategoriesCollectionView {
            ...
            if skillCategoryIndex < skillCategories.count {
                ...
                let rect = skill.localName.boundingRect(with: CGSize(width: CGFloat(Float.greatestFiniteMagnitude), height: SkillSelectionCell.height), options: [.usesLineFragmentOrigin, .usesFontLeading], attributes: skillTextAttributes, context: nil)
